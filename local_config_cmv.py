...
IMPORT_START_DATE = '20221013' # format: '20190501'
...
shift_type_device_mapping = [
    {'shift_type_name': ['SENIOR MERCHANDISER - Admin', 'MERCHANDISER - Admin', 'MERCHANDISER QA - Admin', 'MERCHANDISER MANAGER - Admin', 'JUNIOR MERCHANDISER - Admin', 'LOGISTIC INCHARGE - Admin', 'LOGISTIC EXECUTIVE  - Admin', 'WARDEN - Warden', 'SECURITY GUARD - Night Security', 'SECURITY GUARD - Day Security', 'NURSE', 'House Keeping', 'COOK HELPER - Cook', 'TRAINING INCHARGE - Production Staff', 'TRAINER - Production Staff', 'STORE INCHARGE - Production Staff', 'PURCHASE MANAGER - Production Staff', 'STORE SUPERVISOR - Production Staff', 'SAMPLE TECHNICIAN - Production Staff', 'SAMPLE INCHARGE - Production Staff', 'PRE PRODUCTION MANAGER - Production Staff', 'QAD PRESENTATION - Production Staff', 'Q.C - Production Staff', 'Q.A.D MANAGER - Production Staff', 'Q.A - Production Staff', 'FABRIC QC - Production Staff', 'CUTTING QC - Production Staff', 'AQL AUDITOR - Production Staff', 'TECHNICIAN  - Production Staff', 'SR.TECHNICIAN - Production Staff', 'PRODUCTION-CO-ORDINATOR - Production Staff', 'PRODUCTION INCHARGE - Production Staff', 'LOADING SUPERVISOR - Production Staff', 'LINE SUPERVISOR - Production Staff', 'LINE GUIDE - Production Staff', 'FACTORY MANAGER - Production Staff', 'A.P.M - Production Staff', 'PLANNING ASSISTANT - Production Staff', 'MECHANIC INCHARGE - Production Staff', 'MECHANIC - Production Staff', 'LAB INCHARGE - Production Staff', 'I E - Production Staff', 'I.E iNCHARGE - Production Staff', 'JR.HR EXECUTIVE - Production Staff', 'HR MANAGER - Production Staff', 'DRIVER - Production Staff', 'DEPUTY GENERAL MANAGER - Production Staff', 'PICKING SUPERVISOR - Production Staff', 'FINISHING INCHARGE - Production Staff', 'SAMPLE OPERATOR - Worker', 'TRAINEE - Worker', 'STORE HELPER - Worker', 'LABEL OPERATOR - Worker', 'OPERATOR - Worker', 'BUTTON OPERATOR - Worker', 'QC TRAINEE - Worker', 'CHECKER - Worker', 'TRIMMING - Worker', 'TEMPLATE MACHINE OPERATOR - Worker', 'STAIN REMOVER - Worker', 'PRODUCTION HELPER - Worker', 'LOADING HELPER - Worker', 'BUTTONING HELPER - Worker', 'MAINTENANCE TRAINEE - Worker', 'PICKING - Worker', 'PACKER - Worker', 'IRONER - Worker', 'FINISHING SUPERVISOR - Worker', 'AIRPORT PACKER - Worker', 'FABRIC INCHARGE - Production Staff', 'FABRIC HELPER - Production Staff', 'FABRIC CO-ORDINATOR - Production Staff', 'DATA ENTRY - Production Staff', 'MAINTENANCE INCHARGE - Production Staff', 'ELECTRICIAN - Production Staff', 'EDP-INCHARGE - Admin', 'EDP EXECUTIVE - Admin', 'EDP ASSISTANT - Admin', 'STICKERING HELPER - Worker', 'SPREADER OPERATOR - Worker', 'SPREADER HELPER - Worker', 'FUSING HELPER - Worker', 'CUTTING HELPER - Worker', 'CUTTING SUPERVISOR - Production Staff', 'CUTTING MASTER - Worker', 'CAD INCHARGE - Production Staff', 'CAD ASSISTANT - Production Staff', 'ACCOUNTS ASSISTANT - Admin', 'ACCOUNTANT - Admin', 'SENIOR ACCOUNTANT - Admin', 'ICAD EXECUTIVE -Admin'], 'related_device_id': ['BRM9213360010', 'CEXJ204760487', 'BRM9183860084', 'BRM9213960074', 'BRM9203460113']}
]
